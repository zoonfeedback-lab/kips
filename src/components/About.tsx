      ...
      <div className="container-custom grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
        ...
        <div ref={leftRef} className="flex flex-col">
          ...
          <div className="mt-6 flex flex-col gap-4 text-sm text-kips-text-700">
            <p>
              Under the visionary leadership of <strong>Prof. Sohail Ahmad Khan</strong> and the professional psychiatric guidance of <strong>Dr. Mudassar</strong> (Educational Psychologist), Keyan Institute of Professional Studies (KIPS) stands as a beacon of growth under the <strong>Mashal Technical Education System</strong>.
            </p>
            <p>
              We operate across <strong>7 regional campuses</strong> in Khyber Pakhtunkhwa (KPK) and Azad Jammu & Kashmir (AJK). Our primary mission is to offer highly practical, board-certified courses, technical diplomas, and academic mentoring.
            </p>
          </div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs text-kips-text-400">Regular seminars and counseling led by Dr. Mudassar to guide career choices.</p>
              </div>
            </div>
